...
If you just want "patch whenever something changes," you don't need to write a trailer at all. Nightly cron release shapes lean on this — set `on: schedule:` in your `release.yml` and let cascade do the work.
